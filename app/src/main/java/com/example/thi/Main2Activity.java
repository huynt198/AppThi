    ...
    private void checkexam() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                final JsonObjectRequest jsonOblect = new JsonObjectRequest(Request.Method.POST, CONST.url + "check_code_exam", text, new Response.Listener<JSONObject>() {
                    @Override
...
//                        alertDialogBuilder.setIcon(R.drawable.ic_menu_send);
    ...
    private void getexam(JSONObject response, String test) {
        ...
        if (code.equals("1000")) {
            ...
            try {
                JSONArray data = (JSONArray) ((JSONObject) ((JSONArray) response.getJSONArray("data")).getJSONObject(0)).getJSONArray("questions");
...
//                        alertDialogBuilder.setIcon(R.drawable.ic_menu_send);
            ...
            alertDialogBuilder.setMessage("Ma khong chinh xac, vui long nhap lai");
            alertDialogBuilder.show();
        }
    }
}
